...
<html lang="en">
  ...
  <form action="infopessoal_action.php" role="form" class="form-horizontal" method="POST">
                <div class="form-body" style="margin: 50px;">
                    <div class="form-group row">
                        <label class="col-lg-2 control-label">Email</label>
                        <div class="col-lg-10">
                            <input value="<?php echo $_SESSION['email'] ?>" type="text" class="form-control" name="email" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10">
                            <input value="<?php echo $_SESSION['nome'] ?>" type="text" class="form-control profile_input" name="nome" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10">
                            <input value="<?php echo $_SESSION['data_nascimento'] ?>" type="date" class="form-control profile_input" name="data_nascimento" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10">
                            <input value="<?php echo $_SESSION['cidade'] ?>" type="text" class="form-control profile_input" name="cidade" required>
                        </div>
                    </div>
...
<?php $_SESSION['previous_location'] = "infopessoal.php"; ?>
</html>