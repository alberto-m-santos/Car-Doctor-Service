...
<html>
  ...
  <body>
     ...
     ?>
      ...
      <?php while(isset($row['id'])){ ?>
        ...
        <div class="fixed-container">
            <div><img src="<?php echo $row['fotografia']; ?>" id="photo"></div>
        </div>
        <div class="w3-container">
            <button onclick="document.getElementById('<?php echo "id". $row['id']; ?>').style.display='block'" class="w3-button w3-black"><?php echo $row['nome']; ?></button>
          
            <div id="<?php echo "id". $row['id']; ?>" class="w3-modal">
              <div class="w3-modal-content">
                <div class="w3-container">
                <h4><?php echo $row['nome']; ?></h4>
                  <p><a id="title-link">Material necessário: </a><a id="landing-text"><?php echo $row['material']; ?></a></p>
                    <p><a id="title-link">Tempo estimado: </a><a id="landing-text"><?php echo $row['tempo']; ?></a></p>
                    <p><a id="title-link">Procedimento: </a><a id="landing-text"><?php echo $row['procedimento']; ?></a></p>
                    <br>
                    <button onclick="document.getElementById('<?php echo "id". $row['id']; ?>').style.display='none'" class="w3-button w3-black">Voltar</button>
    ...
    <div class="flex-container back2">
      <h3>Precisas de assistência?<br>Contacta os nossos especialistas!</h3>
    </div>
    <div class="flex-container back2">
        <form action="reparacoes.php" method="POST">
          <a id="title-link"><label for="fname">Nome:</label></a>
          <input type="text" id="fname" name="firstname" placeholder="O teu nome">
          
          <a id="title-link"><label for="lname">Mail:</label></a>
          <input type="text" id="lname" name="lastname" placeholder="O teu endereço de e-mail">
      
          <a id="title-link"><label for="lname">Texto:</label></a>
          <input type="text" id="lname" name="lastname" placeholder="A tua pergunta">
    ...
    <?php } else{ ?>
      ...
      <p><h3> Reservado a utilizadores registados</h3></p>
      <p><h5> Por favor autentique-se ou peça o seu registo na plataforma:</h5></p>
      <p><h5><a href="mailto:cardoctor@mail.pt">cardoctor@mail.pt</a></h5></p>
      <div class="container">
       <div class="row">
          <div class="col-md-12">
  ...
  <?php $_SESSION['previous_location'] = "reparacoes.php"; ?>
</html>