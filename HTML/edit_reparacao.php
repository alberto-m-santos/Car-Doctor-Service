...
<html lang="en">
  ...
  <form action="edit_reparacao_action.php" role="form" class="form-horizontal" method="POST">
                <div class="form-body" style="margin: 50px;">
                      <div class="form-group row">
                        <label class="col-lg-2 control-label">ID</label>
                        <div class="col-lg-10">
                          <input value="<?php echo $_SESSION['edit_rep_id'] ?>" type="text" name="id" class="form-control" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-2 control-label">Nome</label>
                        <div class="col-lg-10">
                          <input value="<?php echo $_SESSION['edit_rep_nome'] ?>" type="text" name="nome" class="form-control" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10">
                          <input value="<?php echo $_SESSION['edit_rep_material'] ?>" type="text" name="material" class="form-control" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10">
                          <input value="<?php echo $_SESSION['edit_rep_tempo'] ?>" type="text" name="tempo" class="form-control" required>
                        </div>
                    </div>

                    <div class="form-group row">
                        <label class="col-lg-2 control-label">Procedimento</label>
                        <div class="col-lg-10">
                          <input value="<?php echo $_SESSION['edit_rep_procedimento'] ?>" type="text" name="procedimento" class="form-control" required>
                        </div>
                    </div>

                    <div class="form-group row">
                        <label class="col-lg-2 control-label">Fotografia</label>
                        <div class="col-lg-10">
                          <input value="<?php echo $_SESSION['edit_rep_fotografia'] ?>" type="text" name="fotografia" class="form-control" required>
                        </div>
                    </div>
