...
<html lang="en">
  ...
  <?php
    if(isset($_SESSION['nome']) and ($_SESSION['is_admin']=='t')){?>
    <h3> Adicionar reparação</h3>
  <form action="add_reparacao_action.php" role="form" class="form-horizontal" method="POST">
                <div class="form-body" style="margin: 50px;">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10">
                          <input type="text" name="fotografia" class="form-control" required>
                        </div>
                    </div>
...
<?php $_SESSION['previous_location'] = "add_reparacao.php"; ?>
</html>