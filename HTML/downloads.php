...
<body>
    ...
    <div id="content" class="p-4cont p-md-5 pt-5">
        <div class="flex-container back">
            <div>
            <div class="fixed-container" id="modalbat">
                <div><img src="../imgs/powerpoint.jpg" id="photo"></div>
            </div>
            <div class="w3-container">
                <a href="Relatorio.pptx" download><button class="w3-button w3-black">Download PowerPoint</button></a>
            </div>
            </div>
    
            <div>
            <div class="fixed-container">
                <div><img src="../imgs/html.jpg" id="photo"></div>
            </div>
            <div class="w3-container">
                <a href="../html.zip" download><button class="w3-button w3-black">Download HTML</button></a>
            ...
            <div>
            <div class="fixed-container">
                <div><img src="../imgs/css.jpg" id="photo"></div>
            </div>
            <div class="w3-container">
                <a href="../css/style.css" download><button class="w3-button w3-black">Download CSS</button></a>
...
<script src= "https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script> 
    ...
    <?php $_SESSION['previous_location'] = "downloads.php"; ?>
</body>