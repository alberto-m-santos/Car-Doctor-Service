...
<body>
  ...
  <div id="content" class="p-4cont p-md-5 pt-5">
    <div class="flex-container back">
      <div>
          <img src="../imgs/eu.jpg" id="photo">
      </div>
    
      <div id="sobre-sets">
        <h5>Autor</h5>
        <p id="sobre-text">Alberto Santos up201708979</p>
        <h5>Estado do trabalho</h5>
        <p id="sobre-text">Final - <a id="sobre-text" href="downloads.php">Relatório</a></p>
        <h5>Acessos na plataforma</h5>
        <p id="sobre-text">user | user e admin | admin</p>
      </div>
...
<script src= "https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script> 
      ...
      <?php $_SESSION['previous_location'] = "sobre.php"; ?>
</body>